...
app.layout = html.Div([
    ...
    dcc.Store(id="cycle_no", storage_type="session"),
...
@app.callback(
    ...
    [Input("project_id", "data"), Input("cycle_id", "data"), Input("cycle_no", "data")]
)
def update_dashboard(project_id, cycle_id, cycle_no):
    ...
    return (
        f"Financial Dashboards for Project {project_id} - Cycle {cycle_no}",
        cost_structure_fig,
        gross_profit_fig,
        net_income_fig,
        ratios_fig
